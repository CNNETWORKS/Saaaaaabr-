...
# Author: @jioxt
# GitHub: https://t.me/+ctTkbDU_di9lYWE1
# Telegram: https://t.me/cnnetworkofficial
# YouTube: https://t.me/cnnetworkofficial
# Created: 2025-01-11
        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__TEAM CN__**."
                )
                return
...
get_user_rename_preference = lambda user_id: user_rename_preferences.get(str(user_id), 'TEAM CN')
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        buttons = [
            ...
            [Button.inline(f"CNLib v1 ⚡{telethon_check}", b'telethon')]
        ]
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **CNLib ⚡**, built on Telethon(base), by TEAM CN still in beta.__", buttons=buttons)
